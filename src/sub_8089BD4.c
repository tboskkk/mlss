...
#else
#error "TODO: write sub_808BFF8 to match asm/nonmatching/sub_808BFF8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_808C04C.s\"");
#else
#error "TODO: write sub_808C04C to match asm/nonmatching/sub_808C04C.s, then delete this #error"
#endif
