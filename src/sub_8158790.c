...
#else
#error "TODO: write sub_8158A50 to match asm/nonmatching/sub_8158A50.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8158A64.s\"");
#else
#error "TODO: write sub_8158A64 to match asm/nonmatching/sub_8158A64.s, then delete this #error"
#endif
