...
#else
#error "TODO: write sub_8027688 to match asm/nonmatching/sub_8027688.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_802772C.s\"");
#else
#error "TODO: write sub_802772C to match asm/nonmatching/sub_802772C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80277C4.s\"");
#else
#error "TODO: write sub_80277C4 to match asm/nonmatching/sub_80277C4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8027A04.s\"");
#else
#error "TODO: write sub_8027A04 to match asm/nonmatching/sub_8027A04.s, then delete this #error"
#endif
