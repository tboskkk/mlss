...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809971C.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8099FA0.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
s32 sub_809A630(void *arg0)
{
  s16 temp_r0_17;
  unsigned int temp_r0_8;
  temp_r0_8 = sub_8086D80();
  if (temp_r0_8 == 0)
  {
    *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_809A76C;
    temp_r0_17 = *((s16 *) (((s8 *) arg0) + 0xAE));
    *((s16 *) (((s8 *) arg0) + 0xAE)) = (s16) (((s32) (temp_r0_17 + (((u32) temp_r0_17) >> 0x1F))) >> 1);
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809A726.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_809AD30(struct Entity *arg0) {
    ...
    if ((s32) (*(s16 *)((s8 *)(temp_r2_30) + (2))) >= (s32) ((*(s16 *)((s8 *)((*(void **)((s8 *)(temp_r6_19) + (8)))) + (2))) + 0x20)) {
        sub_807FB64(temp_r2_30);
        if (0x80 & (*(u8 *)((s8 *)(*(void **)0x03000FD8) + (0xC)))) {
            var_r0_48 = temp_r7_18;
            if (arg0 != temp_r4_15) {
                var_r0_48 = temp_r4_15;
            }
            sub_807FB64((*(void **)((s8 *)(var_r0_48) + (8))));
        }
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809B018.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809B030.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
