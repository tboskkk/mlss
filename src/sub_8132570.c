...
void sub_8132570(struct Entity *arg0) {
    if ((sub_8087CE4() << 0x18) == 0) {
        sub_80883A0(arg0, 0xA);
        arg0->handler = (s32 *) &sub_8132594;
    }
}
...
void sub_81325E8(void *arg0);                       /* extern */
void sub_8132594(void *arg0)
{
  s32 new_var;
  s32 var_r1_14;
  ...
  if ((sub_80883F0() << 0x18) == 0)
  {
    ...
    sub_807F4FC(arg0);
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) &sub_81325E8;
  }
}

ASM_FUNC("asm/nonmatching/sub_81325E8.s", void sub_81325E8(void *arg0));
ASM_FUNC("asm/nonmatching/sub_8132650.s", void sub_8132650(void *arg0));
ASM_FUNC("asm/nonmatching/sub_8132678.s", void sub_8132678(void *arg0));
ASM_FUNC("asm/nonmatching/sub_8132818.s", void sub_8132818(void *arg0));
...
ASM_FUNC("asm/nonmatching/sub_8132AA4.s", void sub_8132AA4(void *arg0));
