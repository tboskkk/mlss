...
#else
#error "TODO: write sub_8102108 to match asm/nonmatching/sub_8102108.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81021E4.s\"");
#else
#error "TODO: write sub_81021E4 to match asm/nonmatching/sub_81021E4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81023C8.s\"");
#else
#error "TODO: write sub_81023C8 to match asm/nonmatching/sub_81023C8.s, then delete this #error"
#endif
