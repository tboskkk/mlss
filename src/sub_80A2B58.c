...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A2B58.s\"");
#else
s32 sub_8082E1C(void *, s32, s32, s32);         /* extern */

void sub_80A2B58(void *arg0) {
    s32 temp_r1_23;
    void *temp_r2_10;
    void *temp_r2_35;
    void *temp_r2_41;
    ...
    if (8 & (*(u8 *)((s8 *)((*(void **)((s8 *)(temp_r4_12) + (8)))) + (0x12)))) {
        ...
        if ((temp_r1_23 == 2) || (temp_r1_23 == 4)) {
            ...
            temp_r2_35 = (*(void **)((s8 *)(temp_r4_12) + (8)));
            (*(u8 *)((s8 *)(temp_r2_35) + (0x11))) = (u8) (-0x41 & (*(u8 *)((s8 *)(temp_r2_35) + (0x11))));
            temp_r2_41 = (*(void **)((s8 *)(temp_r4_12) + (8)));
            (*(u8 *)((s8 *)(temp_r2_41) + (0x12))) = (u8) (-7 & (*(u8 *)((s8 *)(temp_r2_41) + (0x12))));
        }
        (*(s32 *)((s8 *)(arg0) + (0x4C))) = 0;
        (*(s8 *)((s8 *)(arg0) + (0x74))) = 0;
    }
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A2BC0.s\"");
#else
s32 sub_80880C4(void *, s32);                   /* extern */
s32 sub_808843C(void *, s32, s32, s32, s32);    /* extern */
extern s32 sub_80A2C58;

void sub_80A2BC0(void *arg0) {
    s32 temp_r1_23;
    s32 temp_r1_37;
    s32 var_r0_46;
    s32 var_r0_54;
