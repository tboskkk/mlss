...
void sub_8106650(void *arg0)
{
  int temp_r0_9;
  void *temp_r1_14;
  temp_r0_9 = *((s16 *) (((s8 *) arg0) + 0x10));
  if (temp_r0_9 != 0)
  {
    temp_r1_14 = *(*((void ***) 0x03000FD8));
    *((u16 *) (((s8 *) temp_r1_14) + 0x40)) = (u16) ((*((u16 *) (((s8 *) temp_r1_14) + 0x40))) + 1);
    *((s16 *) (((s8 *) arg0) + 0x10)) = (s16) (((u16) (*((s16 *) (((s8 *) arg0) + 0x10)))) - 1);
    return;
  }
  *((s16 *) (((s8 *) arg0) + 0x18)) = temp_r0_9;
  *((s32 **) (((s8 *) arg0) + 4)) = (s32 *) (&sub_8106608);
}
