...
#else
#error "TODO: write sub_8070710 to match asm/nonmatching/sub_8070710.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80707B8.s\"");
#else
#error "TODO: write sub_80707B8 to match asm/nonmatching/sub_80707B8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8070818.s\"");
#else
#error "TODO: write sub_8070818 to match asm/nonmatching/sub_8070818.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8070890.s\"");
#else
#error "TODO: write sub_8070890 to match asm/nonmatching/sub_8070890.s, then delete this #error"
#endif
