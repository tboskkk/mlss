...
void sub_80C0980(struct Entity *arg0) {
    ...
    if (0x20 & (*(u8 *)((s8 *)(arg0) + (0x79)))) {
        (*(s32 *)((s8 *)(arg0) + (0x4C))) = 0;
        (*(s32 **)((s8 *)(temp_r5_8) + (0x4C))) = (s32 *) &sub_80C0CC0;
    }
}
...
void sub_80C0CC0(void *arg0)
{
  s32 temp_r4_9;
  void *temp_r0_12;
  temp_r4_9 = *((s32 *) (((s8 *) arg0) + 0xA8));
  if (temp_r4_9 == 0)
  {
    temp_r0_12 = (void *) (*((void **) (((s8 *) arg0) + 0x28)));
    *((u8 *) (((s8 *) temp_r0_12) + 0x111)) = (u8) ((-3) & (*(((s8 *) temp_r0_12) + 0x111)));
    if ((*((s16 *) (((s8 *) (*((void **) (((s8 *) arg0) + 0x28)))) + 0xF6))) == 0)
    {
      sub_8086700(arg0);
      return;
    }
    *((s32 *) (((s8 *) arg0) + 0x4C)) = temp_r4_9;
  }
}
