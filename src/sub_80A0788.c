...
#else
#error "TODO: write sub_80A08A8 to match asm/nonmatching/sub_80A08A8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0900.s\"");
#else
#error "TODO: write sub_80A0900 to match asm/nonmatching/sub_80A0900.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0994.s\"");
#else
#error "TODO: write sub_80A0994 to match asm/nonmatching/sub_80A0994.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0AF4.s\"");
#else
#error "TODO: write sub_80A0AF4 to match asm/nonmatching/sub_80A0AF4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0B74.s\"");
#else
#error "TODO: write sub_80A0B74 to match asm/nonmatching/sub_80A0B74.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0BFC.s\"");
#else
#error "TODO: write sub_80A0BFC to match asm/nonmatching/sub_80A0BFC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A0D7C.s\"");
#else
#error "TODO: write sub_80A0D7C to match asm/nonmatching/sub_80A0D7C.s, then delete this #error"
#endif
