...
extern s32 sub_80DBD88;

void sub_80DBD50(void *arg0) {
    if (sub_8082B00() == 0) {
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = &sub_80DBD88;
    }
}

extern s32 sub_80DBDE8;

void sub_80DBD6C(void *arg0) {
    if (sub_8082B00() == 0) {
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = &sub_80DBDE8;
    }
}
