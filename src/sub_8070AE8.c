...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8070C2C.s\"");
#else
#error "TODO: write sub_8070C2C to match asm/nonmatching/sub_8070C2C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8070C5C.s\"");
#else
#error "TODO: write sub_8070C5C to match asm/nonmatching/sub_8070C5C.s, then delete this #error"
#endif
