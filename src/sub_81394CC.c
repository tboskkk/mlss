...
#else
#error "TODO: write sub_813955C to match asm/nonmatching/sub_813955C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81395AC.s\"");
#else
#error "TODO: write sub_81395AC to match asm/nonmatching/sub_81395AC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8139614.s\"");
#else
#error "TODO: write sub_8139614 to match asm/nonmatching/sub_8139614.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_813967C.s\"");
#else
#error "TODO: write sub_813967C to match asm/nonmatching/sub_813967C.s, then delete this #error"
#endif
