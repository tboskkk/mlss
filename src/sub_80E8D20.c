...
void sub_80E8D90(void)
{
  void *temp_r0_11;
  void **new_var;
 do { } while (0); new_var = (void **) 0x03000FBC;
  temp_r0_11 = alloc_heap_8018CEC(1U, 0x34U, (s8 *) 0x08200180);
  *new_var = temp_r0_11;
  (*((s32 (**)(s32, void *, s32)) 0x03001034))(0, temp_r0_11, 0x34);
}

s32 sub_80E57FC();                              /* extern */
