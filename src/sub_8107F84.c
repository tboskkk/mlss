...
#else
#error "TODO: write sub_81083EC to match asm/nonmatching/sub_81083EC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81084B4.s\"");
#else
#error "TODO: write sub_81084B4 to match asm/nonmatching/sub_81084B4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_810857C.s\"");
#else
#error "TODO: write sub_810857C to match asm/nonmatching/sub_810857C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81086B4.s\"");
#else
#error "TODO: write sub_81086B4 to match asm/nonmatching/sub_81086B4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81087F0.s\"");
#else
#error "TODO: write sub_81087F0 to match asm/nonmatching/sub_81087F0.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8108928.s\"");
#else
#error "TODO: write sub_8108928 to match asm/nonmatching/sub_8108928.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81089A4.s\"");
#else
#error "TODO: write sub_81089A4 to match asm/nonmatching/sub_81089A4.s, then delete this #error"
#endif
