...
#else
#error "TODO: write sub_81321B4 to match asm/nonmatching/sub_81321B4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81322D8.s\"");
#else
#error "TODO: write sub_81322D8 to match asm/nonmatching/sub_81322D8.s, then delete this #error"
#endif
