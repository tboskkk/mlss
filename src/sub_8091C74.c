...
void sub_8091FDC(struct Entity *arg0);

s32 sub_8082E1C();
void sub_8091FB0(struct Entity *arg0);
...
extern s32 sub_8091E00;
void sub_8091CC8(void *arg0)
{
  ...
  *((s32 *) (((s8 *) arg0) + 0x94)) = -0x48;
  ...
  new_var = -7;
  *((u8 *) (((s8 *) temp_r2_22) + 0x12)) = (u8) ((new_var & (*((u8 *) (((s8 *) temp_r2_22) + 0x12)))) | 2);
  *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_8091E00;
}

void sub_8091CC8(void *arg0);

void sub_8091D10(struct Entity *arg0) {
    s32 temp_r0_11;
...
extern s32 sub_8091E70;
void sub_8091D34(void *arg0)
{
  void *new_var;
  void *temp_r2_23;
  play_sfx_80195B4(0x2B, -1);
  *((s32 *) (((s8 *) arg0) + 0x94)) = -0x58;
  ...
  temp_r2_23 = (void *) (new_var = *((void **) (((s8 *) arg0) + 8)));
  *((u8 *) (((s8 *) temp_r2_23) + 0x12)) = (u8) (((-7) & (*(((s8 *) temp_r2_23) + 0x12))) | 2);
  *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_8091E70;
}

void sub_8091D34(void *arg0);

void sub_8091D78(struct Entity *arg0) {
    s32 temp_r0_11;
...
void sub_8091F48(void *arg0)
{
  ...
  *((s32 *) (((s8 *) arg0) + 0x18)) = temp_r1_18;
  if (temp_r1_18 <= ((s32) (*((s32 *) (((s8 *) (*((void **) (((s8 *) arg0) + 0x28)))) + 0xE0)))))
  {
    ...
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) (&sub_8091FDC);
  }
}
...
void sub_8092DD4(struct Entity *arg0) {
    if (0x38 & (*(u8 *)((s8 *)(arg0) + (0x76)))) {
        sub_808DD2C(arg0);
        return;
    }
