...
void sub_80872A8(void *arg0)
{
  ...
  *((u8 *) (((s8 *) temp_r2_48) + 0x12)) = (u8) (new_var & (*((u8 *) (((s8 *) temp_r2_48) + 0x12))));
  var_r0_27 = 0;
  block_5:
...
void sub_8087318(void *arg0, s32 arg1, s32 arg2)
{
  ...
  sub_808843C(arg0, new_var, var_r2_17 >> 8, 0, 0x100);
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_808742C.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8087440.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
