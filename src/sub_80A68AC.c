...
void sub_80A6BD8(void *arg0)
{
  ...
  {
    *((u8 *) (((s8 *) temp_r4_11) + 0xD4)) = (u8) ((-0x80) & (*(((s8 *) temp_r4_11) + 0xD4)));
    *((s16 *) (((s8 *) temp_r4_11) + 0xD2)) = new_var;
    sub_810D738(temp_r5_13, temp_r6_14, 0, 0, 0x08018105);
    *((u16 *) (((s8 *) temp_r5_13) + 0x24)) = (u16) ((*((u16 *) (((s8 *) temp_r5_13) + 0x24))) + 1);
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) &sub_80A68AC;
  }
}

extern s32 sub_80A64C4;
void sub_80A6C44(void *arg0)
{
  s32 temp_r6_14;
  int new_var;
  int *new_var3;
  ...
  void *temp_r5_13;
  int new_var2;
  temp_r4_11 = (void *) (*((void **) (((s8 *) (*((void **) 0x03000FD8))) + 0x74)));
  new_var = 0x100;
  ...
  if (0x20 & (*((u8 *) (((s8 *) temp_r4_11) + 0x81))))
  {
    new_var2 = 0xD4;
    new_var3 = &new_var;
    *((u8 *) (((s8 *) temp_r4_11) + new_var2)) = (u8) ((-0x80) & (*(((s8 *) temp_r4_11) + new_var2)));
    *((s16 *) (((s8 *) temp_r4_11) + 0xD2)) = *new_var3;
    sub_810D738(temp_r5_13, temp_r6_14, 0, 0, 0x08018005);
    *((u16 *) (((s8 *) temp_r5_13) + 0x24)) = (u16) ((*((u16 *) (((s8 *) temp_r5_13) + 0x24))) + 1);
    *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_80A64C4;
  }
}
