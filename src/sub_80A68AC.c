...
#else
#error "TODO: write sub_80A69E0 to match asm/nonmatching/sub_80A69E0.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A6BD8.s\"");
#else
#error "TODO: write sub_80A6BD8 to match asm/nonmatching/sub_80A6BD8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A6C44.s\"");
#else
#error "TODO: write sub_80A6C44 to match asm/nonmatching/sub_80A6C44.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A6CB0.s\"");
#else
#error "TODO: write sub_80A6CB0 to match asm/nonmatching/sub_80A6CB0.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A6D44.s\"");
#else
#error "TODO: write sub_80A6D44 to match asm/nonmatching/sub_80A6D44.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A6F78.s\"");
#else
#error "TODO: write sub_80A6F78 to match asm/nonmatching/sub_80A6F78.s, then delete this #error"
#endif
