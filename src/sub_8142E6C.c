...
#else
#error "TODO: write sub_8143128 to match asm/nonmatching/sub_8143128.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81431CC.s\"");
#else
#error "TODO: write sub_81431CC to match asm/nonmatching/sub_81431CC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81432CC.s\"");
#else
#error "TODO: write sub_81432CC to match asm/nonmatching/sub_81432CC.s, then delete this #error"
#endif
