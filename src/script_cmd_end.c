...
#else
#error "TODO: write sub_80EB490 to match asm/nonmatching/sub_80EB490.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80EB524.s\"");
#else
#error "TODO: write sub_80EB524 to match asm/nonmatching/sub_80EB524.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80EB838.s\"");
#else
#error "TODO: write sub_80EB838 to match asm/nonmatching/sub_80EB838.s, then delete this #error"
#endif
