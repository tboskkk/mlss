...
#else
#error "TODO: write sub_8098540 to match asm/nonmatching/sub_8098540.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809861C.s\"");
#else
#error "TODO: write sub_809861C to match asm/nonmatching/sub_809861C.s, then delete this #error"
#endif
