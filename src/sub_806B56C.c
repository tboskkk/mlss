...
s32 sub_8082E1C();
void sub_806B56C(struct Entity *arg0) {
...
void sub_806B584(struct Entity *arg0) {
    sub_8082E1C(arg0, 5, 0, 0);
    arg0->handler = &sub_806AA18;
    (*(s16 *)((s8 *)(arg0) + (0xAC))) = 0;
}

extern s32 sub_806B5F8;

void sub_806B5A8(struct Entity *arg0) {
    if (8 & (*(u8 *)((s8 *)(arg0->unk08) + (0x12)))) {
        if (arg0->unkA8 == 0) {
