...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_809B4EC.s\"");
#else
...
extern s32 sub_809B5A8;
void sub_809B504(void *arg0)
{
  int new_var;
  void *temp_r2_21;
  new_var = -7;
  ...
  if (0x20 & (*((u8 *) (((s8 *) arg0) + 0x79))))
  {
    ...
    *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_809B5A8;
  }
}

extern s32 sub_809B610;
void sub_809B558(void *arg0)
{
  void *temp_r2_21;
  *((s32 *) (((s8 *) arg0) + 0x14)) = (s32) ((*((s32 *) (((s8 *) arg0) + 0x14))) + 0x100);
  *((s32 *) (((s8 *) arg0) + 0x18)) = 0x2600;
  sub_8082E1C(arg0, 1, 0x40C2, 0);
  temp_r2_21 = *((void **) (((s8 *) arg0) + 8));
  *((u8 *) (((s8 *) temp_r2_21) + 0x12)) = (u8) (((-7) & (*(((s8 *) temp_r2_21) + 0x12))) | 2);
  play_sfx_80195B4(0x15D, -1);
  *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_809B610;
}
