...
void sub_8066C90(void *arg0) {
    if (8 & (*(u8 *)((s8 *)((*(void **)((s8 *)(arg0) + (8)))) + (0x12)))) {
        sub_8082E1C(arg0, 9, 0, 0);
        (*(s16 *)((s8 *)(arg0) + (0xAC))) = 2;
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = (s32 *) &sub_8066CEC;
    }
}

s32 sub_8066CC4(void *arg0) {
    (*(s32 *)((s8 *)(arg0) + (0x9C))) = 1;
    (*(s32 *)((s8 *)(arg0) + (0x4C))) = 0x08066D51;
    return 1;
}

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8066CD8.s\"");
#else
