...
extern s32 sub_8082370;
void sub_808231C(void *arg0)
{
  u16 temp_r0_14;
  void *temp_r2_33;
  long long new_var;
  ...
  {
    sub_8082E1C(temp_r4_8, 0, 0, 0);
    new_var = -7;
    temp_r2_33 = *((void **) (((s8 *) temp_r4_8) + 8));
    *((u8 *) (((s8 *) temp_r2_33) + 0x12)) = (u8) (new_var & (*((u8 *) (((s8 *) temp_r2_33) + 0x12))));
    *((s32 **) (((s8 *) arg0) + 4)) = &sub_8082370;
  }
}
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8082718.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80829D0.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80829D4.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
