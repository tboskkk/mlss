...
s32 sub_80F2524(s32, u8, s32);                  /* extern */

void sub_80F7770(void *arg0) {
    void *temp_r1_20;

    sub_80F2524((*(s32 *)((s8 *)(*(void **)0x03000FD8) + (0x244))), (*(u8 *)((s8 *)(arg0) + (0xF4))), (*(s32 *)((s8 *)(arg0) + (0xE8))));
    temp_r1_20 = *(void **)0x03000FD8;
    (*(u8 *)((s8 *)(temp_r1_20) + (0x2BF))) = (u8) ((*(u8 *)((s8 *)(temp_r1_20) + (0x2BF))) | 4);
}
