...
void sub_816D734(void *arg0)
{
  ...
  u32 temp_r0_18;
  u32 temp_r0_31;
  temp_r0_10 = *((s32 *) (((s8 *) arg0) + 0x78));
  temp_r3_9 = *((s32 *) (((s8 *) arg0) + 0x70));
  temp_r0_10 = temp_r0_10 + temp_r3_9;
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_816D778.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_816D798.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_816D7CC.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
