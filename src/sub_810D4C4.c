...
#else
#error "TODO: write sub_810D524 to match asm/nonmatching/sub_810D524.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_810D57C.s\"");
#else
#error "TODO: write sub_810D57C to match asm/nonmatching/sub_810D57C.s, then delete this #error"
#endif
