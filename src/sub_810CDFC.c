...
s32 sub_810AA24(void *);                        /* extern */
extern s32 sub_810D694;
void sub_810CE88(void *arg0)
{
  int new_var;
  void *temp_r2_8;
  temp_r2_8 = (void *) (*((void **) (((s8 *) arg0) + 0xC)));
  *((u16 *) (((s8 *) temp_r2_8) + 0x16)) = (u16) ((*((u16 *) (((s8 *) temp_r2_8) + 0x16))) - 3);
  new_var = *((u16 *) 0x0200001A);
  if (((s32) (new_var - 0xF)) > ((s32) ((s16) (*((u16 *) (((s8 *) temp_r2_8) + 0x16))))))
  {
    new_var = 0x16;
    *((u16 *) (((s8 *) temp_r2_8) + new_var)) = (u16) ((*((u16 *) 0x0200001A)) - 0xF);
    sub_810AA24(arg0);
    *((s32 **) (((s8 *) arg0) + 4)) = &sub_810D694;
  }
}

void sub_810CE88(void *arg0);

void sub_810CEC0(void *arg0) {
    if (0x40 & (*(u8 *)((s8 *)(*(void **)0x03000FD8) + (0xB)))) {
        sub_810CE88(arg0);
        return;
    }
    if ((s32) (s16) (*(u16 *)((s8 *)(arg0) + (0x16))) > 0) {
        (*(u16 *)((s8 *)(arg0) + (0x16))) = (u16) ((*(u16 *)((s8 *)(arg0) + (0x16))) - 1);
        return;
    }
    if ((*(s16 *)((s8 *)(arg0) + (0x18))) == 0) {
        (*(u16 *)((s8 *)(arg0) + (0x12))) = (u16) ((*(u16 *)((s8 *)(arg0) + (0x12))) + 0x40);
    }
}
...
void sub_810D038(s32 arg0) {
    sub_810D00C();
    sub_8084578((*(s32 *)((s8 *)(*(void **)0x03000FD8) + (0x250))), 0, 0, 0xD, 0, 0x12, 3);
    sub_80847B0((*(s32 *)((s8 *)(*(void **)0x03000FD8) + (0x250))), 1, 0, 0);
    sub_808520C((*(s32 *)((s8 *)(*(void **)0x03000FD8) + (0x250))), 0, 7, 6, arg0, 0x91);
}
...
s32 sub_80827F0(s32, s32, s32, s32, s32, s32);  /* extern */
void sub_810D11C(void)
{
  s8 *new_var;
  void *new_var2;
  new_var2 = (void *) 0x084FB588;
  sub_80827F0(0, (*((s32 *) (0x089F808C + ((*((u16 *) (((s8 *) new_var2) + 0x10))) * 4)))) + 0x089F808C, (*((s32 *) 0x03000FDC)) + 0x4E70, -1, 0, 0);
  new_var = (s8 *) (((s8 *) (*((void **) 0x03000FD8))) + 0x2BC);
  *new_var = 0;
}
