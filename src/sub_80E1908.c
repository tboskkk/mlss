...
#else
#error "TODO: write sub_80E195C to match asm/nonmatching/sub_80E195C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80E19A8.s\"");
#else
#error "TODO: write sub_80E19A8 to match asm/nonmatching/sub_80E19A8.s, then delete this #error"
#endif
