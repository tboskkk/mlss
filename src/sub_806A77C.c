...
void sub_806A3F8(void *arg0);                       /* extern */
int sub_8082B00();
s32 sub_8082E1C();
...
void sub_806A47C(void *arg0);                       /* extern */
...
void sub_806A83C(void *arg0) {
    if ((*(s32 *)((s8 *)(arg0) + (0x80))) == 0) {
        ...
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = (s32 *) &sub_806A47C;
    }
}
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806A884.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806A888.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_806A8B0(void *arg0)
{
  ...
  temp_r0_11 = (*((u16 *) (((s8 *) arg0) + 0xAC)) = new_var - 1);
