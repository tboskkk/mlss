...
#else
#error "TODO: write sub_816129C to match asm/nonmatching/sub_816129C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81612E4.s\"");
#else
#error "TODO: write sub_81612E4 to match asm/nonmatching/sub_81612E4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_81612F8.s\"");
#else
#error "TODO: write sub_81612F8 to match asm/nonmatching/sub_81612F8.s, then delete this #error"
#endif
