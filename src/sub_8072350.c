...
s32 sub_8072400(void *arg0)
{
  ...
  if (var_r0_8 == 0)
  {
    *((s32 *) (((s8 *) arg0) + (var_r0_8 = 0x8C))) = 0x300;
...
extern s32 sub_807148C;
void sub_807249C(void *arg0)
{
  ...
  if (8 & (*((u8 *) (((s8 *) (*((void **) (((s8 *) arg0) + 8)))) + 0x12))))
  {
    ...
    *((u16 *) (((s8 *) arg0) + 0xAC)) = temp_r0_17;
    ...
    {
      sub_8082E1C(arg0, 5, 0x40B4, 0);
      sub_8082E1C(*((void **) (((s8 *) arg0) + 0x30)), 5, 0, 0);
      *((s32 **) (((s8 *) arg0) + 0x4C)) = &sub_807148C;
    }
  }
}

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80724E8.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80724F4.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_80726D4(void *arg0)
{
  unsigned int temp_r0_11;
  void *temp_r4_31;
  temp_r0_11 = (*((u16 *) (((s8 *) arg0) + 0xAE))) + 1;
  *((u16 *) (((s8 *) arg0) + 0xAE)) = temp_r0_11;
  if (((s16) temp_r0_11) == ((0, 0x37)))
  {
    play_sfx_80195B4(0x9D, -1);
  }
  if (8 & (*((u8 *) (((s8 *) (*((void **) (((s8 *) arg0) + 8)))) + 0x12))))
  {
    temp_r4_31 = (void *) ((*((s32 *) (((s8 *) (*((void **) 0x03000FD8))) + 0x58))) + 8);
    sub_8082E1C(arg0, 0x14, 0, 0);
    sub_8082E1C(temp_r4_31, 0, 0x40AE, 0);
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) (&sub_8072738);
  }
}
