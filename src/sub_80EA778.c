...
#else
#error "TODO: write sub_80EA88C to match asm/nonmatching/sub_80EA88C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80EA8A4.s\"");
#else
#error "TODO: write sub_80EA8A4 to match asm/nonmatching/sub_80EA8A4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80EA8DC.s\"");
#else
#error "TODO: write sub_80EA8DC to match asm/nonmatching/sub_80EA8DC.s, then delete this #error"
#endif
