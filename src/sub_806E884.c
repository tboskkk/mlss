...
#else
#error "TODO: write sub_806EB18 to match asm/nonmatching/sub_806EB18.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806ECA4.s\"");
#else
#error "TODO: write sub_806ECA4 to match asm/nonmatching/sub_806ECA4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806EDBC.s\"");
#else
#error "TODO: write sub_806EDBC to match asm/nonmatching/sub_806EDBC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806EF38.s\"");
#else
#error "TODO: write sub_806EF38 to match asm/nonmatching/sub_806EF38.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806F034.s\"");
#else
#error "TODO: write sub_806F034 to match asm/nonmatching/sub_806F034.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806F2D8.s\"");
#else
#error "TODO: write sub_806F2D8 to match asm/nonmatching/sub_806F2D8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806F3F4.s\"");
#else
#error "TODO: write sub_806F3F4 to match asm/nonmatching/sub_806F3F4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806F47C.s\"");
#else
#error "TODO: write sub_806F47C to match asm/nonmatching/sub_806F47C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_806F508.s\"");
#else
#error "TODO: write sub_806F508 to match asm/nonmatching/sub_806F508.s, then delete this #error"
#endif
