...
#else
#error "TODO: write sub_80A3E68 to match asm/nonmatching/sub_80A3E68.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A3F3C.s\"");
#else
#error "TODO: write sub_80A3F3C to match asm/nonmatching/sub_80A3F3C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A4198.s\"");
#else
#error "TODO: write sub_80A4198 to match asm/nonmatching/sub_80A4198.s, then delete this #error"
#endif
