...
#else
#error "TODO: write sub_8088020 to match asm/nonmatching/sub_8088020.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80880C4.s\"");
#else
#error "TODO: write sub_80880C4 to match asm/nonmatching/sub_80880C4.s, then delete this #error"
#endif
