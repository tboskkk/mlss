...
#else
#error "TODO: write sub_80F0938 to match asm/nonmatching/sub_80F0938.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80F095C.s\"");
#else
#error "TODO: write sub_80F095C to match asm/nonmatching/sub_80F095C.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80F0984.s\"");
#else
#error "TODO: write sub_80F0984 to match asm/nonmatching/sub_80F0984.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80F09A8.s\"");
#else
#error "TODO: write sub_80F09A8 to match asm/nonmatching/sub_80F09A8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80F09E8.s\"");
#else
#error "TODO: write sub_80F09E8 to match asm/nonmatching/sub_80F09E8.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80F0A30.s\"");
#else
#error "TODO: write sub_80F0A30 to match asm/nonmatching/sub_80F0A30.s, then delete this #error"
#endif
