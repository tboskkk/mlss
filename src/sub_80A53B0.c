...
#else
#error "TODO: write sub_80A54E4 to match asm/nonmatching/sub_80A54E4.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80A56DC.s\"");
#else
#error "TODO: write sub_80A56DC to match asm/nonmatching/sub_80A56DC.s, then delete this #error"
#endif
