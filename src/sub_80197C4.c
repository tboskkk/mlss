...
#else
#error "TODO: write sub_80198B0 to match asm/nonmatching/sub_80198B0.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8019940.s\"");
#else
#error "TODO: write sub_8019940 to match asm/nonmatching/sub_8019940.s, then delete this #error"
#endif
