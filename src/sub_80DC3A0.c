...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DC448.s\"");
#else
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DC460.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DC46C.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DC478.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_80DC5FC(void *arg0)
{
  ...
  if ((*((s32 *) (((s8 *) arg0) + 0x80))) == 0)
  {
    ...
    *((u8 *) (((s8 *) temp_r2_17) + 0x12)) = (u8) ((new_var2 & (*((u8 *) (((s8 *) temp_r2_17) + 0x12)))) | 2);
    sub_807F4FC(arg0);
    new_var = (s8 *) arg0;
    *((s32 **) (new_var + 0x4C)) = (s32 *) &sub_80DC668;
  }
}
...
void sub_80DC668(void *arg0) {
    if (8 & (*(u8 *)((s8 *)((*(void **)((s8 *)(arg0) + (8)))) + (0x12)))) {
        ...
        (*(s16 *)((s8 *)(arg0) + (0xAC))) = 0x20;
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = &sub_80DC0E0;
    }
}

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DC6A4.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_80DC7C4(struct Entity *arg0) {
    s32 temp_r0_60;
    s32 temp_r1_64;
    s32 var_r0_16;
    s32 var_r0_31;
    ...
    (*(s32 *)((s8 *)(arg0) + (0x10))) = (s32) (arg0->unk38 + (*(s16 *)((s8 *)(arg0) + (0xAE))));
    (*(s32 *)((s8 *)(arg0) + (0x14))) = (s32) ((*(s32 *)((s8 *)(arg0) + (0x3C))) + (*(s16 *)((s8 *)(arg0) + (0xB0))));
    temp_r0_60 = arg0->unk40 + (s16) (*(u16 *)((s8 *)(arg0) + (0xB2)));
    arg0->unk18 = temp_r0_60;
    temp_r1_64 = (*(s32 *)((s8 *)(arg0) + (0x98)));
    if (temp_r0_60 <= temp_r1_64) {
        arg0->unk18 = temp_r1_64;
...
extern s32 sub_80DD588;

s32 sub_80DD600(void *arg0) {
    s32 temp_r0_8;
    u32 temp_r0_16;
    void *temp_r1_26;
    ...
    if (temp_r0_8 == 0) {
        temp_r0_16 = 0 - (*(s16 *)((s8 *)(arg0) + (0xAE)));
        (*(s16 *)((s8 *)(arg0) + (0xAE))) = (s16) ((s32) (temp_r0_16 + (temp_r0_16 >> 0x1F)) >> 1);
        (*(s16 *)((s8 *)(arg0) + (0xB0))) = temp_r0_8;
        (*(s16 *)((s8 *)((arg0 + 0xB0)) + (2))) = temp_r0_8;
        temp_r1_26 = (void *) ((*(void **)((s8 *)(arg0) + (0x30))));
        if (temp_r1_26 != NULL) {
            (*(s16 *)((s8 *)(temp_r1_26) + (0xAC))) = 8;
        }
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = &sub_80DD588;
        sub_8082E1C(arg0, 0, 0, 0);
    }
    return temp_r0_8;
}
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DD654.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DD660.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DD66C.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DD678.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_80DD684.s\"");
#else
/* No C attempt yet. Deliberately EMPTY rather than an #error: agbcc
   compiles a whole translation unit at a time, so an #error here fails
   every OTHER function in this file under NONMATCHING=1. Guard intact, so
...
void sub_80DD708(struct Entity *arg0) {
    if (sub_8082B00() == 0) {
        arg0->handler = (s32 *) &sub_80DD798;
    }
}

void sub_80DD7C4(void *arg0);
void sub_80DD724(struct Entity *arg0) {
    if (sub_8082B00() == 0) {
        arg0->handler = (s32 *) &sub_80DD7C4;
    }
}
