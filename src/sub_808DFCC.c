...
void sub_808E0C8(struct Entity *arg0);

s32 sub_8082E1C();
void sub_808E09C(struct Entity *arg0);
...
void sub_808DFCC(void *arg0)
{
  ...
  *((s32 *) (((s8 *) arg0) + 0x18)) = temp_r1_18;
  if (temp_r1_18 <= ((s32) (*((s32 *) (((s8 *) (*((void **) (((s8 *) arg0) + 0x28)))) + 0xE0)))))
  {
    ...
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) (&sub_808E09C);
  }
}

void sub_808E034(void *arg0)
{
  s32 temp_r1_18;
  u8 *temp_r2_25;
  int new_var;
  ...
  *((s32 *) (((s8 *) arg0) + 0x18)) = temp_r1_18;
  if (temp_r1_18 <= ((s32) (*((s32 *) (((s8 *) (*((void **) (((s8 *) arg0) + 0x28)))) + 0xE0)))))
  {
    ...
    *((s32 **) (((s8 *) arg0) + 0x4C)) = (s32 *) (&sub_808E0C8);
  }
}
