...
ASM_FUNC("asm/nonmatching/sub_8108B10.s", void sub_8108B10(void *arg0));
void sub_8108B50(void *arg0)
{
  ...
  if ((((s16) new_var2) == 0) || ((temp_r0_13, *((u16 *) (((s8 *) arg0) + 0x10)) = new_var2 - 1, ((new_var2 - 1) << 0x10) == 0)))
  {
    ...
    new_var = (s32 *) &sub_8108B10;
    *((s32 **) (((s8 *) arg0) + 4)) = new_var;
  }
}

ASM_FUNC("asm/nonmatching/sub_8108B84.s", void sub_8108B84(void *arg0));