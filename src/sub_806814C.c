...
extern s32 sub_8067A84;

void sub_806829C(void *arg0) {
    if (8 & (*(u8 *)((s8 *)((*(void **)((s8 *)(arg0) + (8)))) + (0x12)))) {
        sub_8082E1C(arg0, 3, 0, 0);
        (*(s32 **)((s8 *)(arg0) + (0x4C))) = &sub_8067A84;
    }
}
