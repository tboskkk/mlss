...
#else
#error "TODO: write sub_81542DC to match asm/nonmatching/sub_81542DC.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8154420.s\"");
#else
#error "TODO: write sub_8154420 to match asm/nonmatching/sub_8154420.s, then delete this #error"
#endif

#ifndef NONMATCHING
asm_unified(".include \"asm/nonmatching/sub_8154594.s\"");
#else
#error "TODO: write sub_8154594 to match asm/nonmatching/sub_8154594.s, then delete this #error"
#endif
