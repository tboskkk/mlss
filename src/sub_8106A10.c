...
s32 sub_8082B00();
void sub_8100E5C(s32 arg0);                       /* extern */
...
s32 sub_810D260(s16, s32);                          /* extern */
...
void sub_8106B90(void *arg0) {
    sub_810D3B8((*(s16 *)((s8 *)(arg0) + (0x16))), (*(s16 *)((s8 *)(arg0) + (0x12))) + 8, (*(s16 *)((s8 *)(arg0) + (0x14))) - 8, 0);
}

void *sub_807FFD8(s32, s32 *);                  /* extern */
void sub_8102F54(void *arg0);                       /* extern */
extern s32 sub_81071F0;
void sub_8106BB0(void *arg0)
{
  int new_var;
  void *temp_r0_16;
  if ((sub_8082B00() << 0x18) == 0)
  {
    temp_r0_16 = sub_807FFD8((*((s32 *) 0x03000FD8)) + 0x4C, &sub_81071F0);
    *((s16 *) (((s8 *) temp_r0_16) + 0x12)) = (s16) (new_var = *((s16 *) (((s8 *) arg0) + 0x12)));
    *((s32 *) (((s8 *) temp_r0_16) + 0xC)) = (s32) (*((s32 *) (((s8 *) arg0) + 0xC)));
    *((s32 **) (((s8 *) arg0) + 4)) = (s32 *) &sub_8102F54;
  }
}
...
extern s32 sub_8101A6C;

void sub_8106C10(void *arg0) {
    u8 temp_r5_20;
    ...
    temp_r5_20 = sub_8082B00();
    if (temp_r5_20 == 0) {
        sub_801E150(sub_8084338(0x7002, 0, 0, 0), 0, -1, 0, (s32) temp_r5_20);
        sub_807F6D0();
        (*(s32 **)((s8 *)(arg0) + (4))) = &sub_8101A6C;
    }
}
...
void sub_8106DF0(void *arg0)
{
  u16 temp_r0_9;
  temp_r0_9 = (*((u16 *) (((s8 *) arg0) + 0x10))) - 1;
  *((u16 *) (((s8 *) arg0) + 0x10)) = (*((u16 *) (((s8 *) arg0) + 0x10))) - 1;
  if ((((s32) (temp_r0_9 << 0x10)) <= 0) && ((sub_8082B00() << 0x18) == 0))
  {
    sub_810CA30();
    *((s32 **) (((s8 *) arg0) + 4)) = (s32 *) &sub_8100E5C;
  }
}
...
void sub_8100D18(void *arg0);                       /* extern */
...
s32 sub_807FA94();                                  /* extern */
s32 sub_807FB34(s32);                           /* extern */
void sub_8106EE8(void *arg0)
{
  s8 *new_var;
  void *temp_r0_9;
  temp_r0_9 = *((void **) 0x03000FD8);
  new_var = ((s8 *) temp_r0_9) + 0x364;
  if ((*((s32 *) (((s8 *) (*((void **) (((s8 *) temp_r0_9) + 0x364)))) - -8))) != 0)
  {
    do
    {
    }
  ...
  sub_807FB34(*((s32 *) (((s8 *) (*((void **) new_var))) + 4)));
  *((s32 *) (((s8 *) (*((void **) new_var))) + 4)) = 0;
  *((void **) new_var) = (void *) 0;
  *((s32 *) (((s8 *) arg0) + 4)) = (s32) (*((s32 *) (((s8 *) (*((void **) 0x03000FDC))) + 0x8E58)));
}

s32 sub_80F8E80(s32, u8, s32);                  /* extern */
void sub_8106F34(void *arg0)
{
  void *temp_r1_18;
  s32 new_var;
  void *temp_r1_30;
  ...
  if ((sub_8082B00() << 0x18) == 0)
  {
    *((s32 **) (((s8 *) arg0) + 4)) = (s32 *) &sub_8106D9C;
    sub_80F75D8(0x100);
    temp_r1_18 = *((void **) 0x03000FD8);
    new_var = *((s32 *) (((s8 *) temp_r1_18) + 0x244));
    temp_r2_23 = *((void **) (((s8 *) temp_r1_18) + 0x7C));
    sub_80F8E80(new_var, *((u8 *) (((s8 *) temp_r2_23) + 0xF4)), *((s32 *) (((s8 *) temp_r2_23) + 0xE8)));
    temp_r1_30 = *((void **) 0x03000FD8);
    *((u8 *) (((s8 *) temp_r1_30) + 0x2BF)) = (u8) ((*((u8 *) (((s8 *) temp_r1_30) + 0x2BF))) | 4);
  }
}
