...
|---|---:|---:|---|
| **matched** | 1,795 | 27.6% | compiles byte-identical to retail |
| **in progress** | 2,639 | 40.6% | extracted, a real C attempt exists |
| **not started** | 2,050 | 31.5% | extracted, no attempt yet |
| **not extracted** | 21 | 0.3% | still raw in `asm/*.s` |
| | **6,505** | | **total (game proper)** |
